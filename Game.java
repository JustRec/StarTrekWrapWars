...
public class Game {
	...
	private static void InitPlayerAction() {
		...
		if (action == 87 && !(Backpack.isEmpty())) {
			if (retCol(0, -1) == ' ' && (Backpack.peekItem().toString().charAt(0) == '*'
					|| Backpack.peekItem().toString().charAt(0) == '=')) {
				PlayerThrow(0, -1);
			} else if (Backpack.peekItem().toString().charAt(0) != '*'
					&& Backpack.peekItem().toString().charAt(0) != '=') {
				PlayerThrow(0, -1);
			}
		}
		...
		if (action == 65 && !(Backpack.isEmpty())) {
			if (retCol(-1, 0) == ' ' && (Backpack.peekItem().toString().charAt(0) == '*'
					|| Backpack.peekItem().toString().charAt(0) == '=')) {
				PlayerThrow(-1, 0);
			} else if (Backpack.peekItem().toString().charAt(0) != '*'
					&& Backpack.peekItem().toString().charAt(0) != '=') {
